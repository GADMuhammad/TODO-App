...
function App() {
  ...
  return (
    <AppContext.Provider value={{ changeState, onDeleteTask }}>
      ...
      />
      <div className="animate-up mx-auto mb-5 w-[40rem] rounded-md bg-slate200 shadow-lg max-md:w-11/12">
        {Object.keys(tasks).length === 0 ? (
          <p className="animate-up p-5 text-xl tracking-wider text-gray-400">
            No task to display.
          </p>
        ) : (
